    ...
    <div class="form-content">
        <form id="personalForm" method="POST">
            ...
            <div class="form-section">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <select name="beschaeftigungsart" id="beschaeftigungsart" required>
                ...
                <div class="form-row" id="gehalt-row" style="display: none;">
                    <div class="form-group">
                        <label>Gehalt <span class="required">*</span></label>
                        <input type="number" name="gehalt" id="gehalt">
                    </div>
                </div>

                <script>
                document.getElementById("beschaeftigungsart").addEventListener("change", function () {
                    const gehaltRow = document.getElementById("gehalt-row");
                    const gehaltInput = document.getElementById("gehalt");

                    if (this.value === "Vollzeit") {
                        gehaltRow.style.display = "block";
                        gehaltInput.setAttribute("required", "required");
                    } else {
                        gehaltRow.style.display = "none";
                        gehaltInput.removeAttribute("required");
                        gehaltInput.value = ""; // optional: clear value when hidden
                    }
                });
                </script>
            ...
            <div class="file-upload-section">
                <h3>Stundenzettel Dokumente</h3>
                <p style="color: #6c757d; margin-bottom: 15px; font-size: 14px;">
                    Fügen Sie weitere Stundenzettel Dokumente hinzu
                </p>
